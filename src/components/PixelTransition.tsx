...
const PixelTransition: React.FC<PixelTransitionProps> = ({
  ...
  // BARU: Tambahkan ref untuk konten pertama
  ...
  const animatePixels = (activate: boolean): void => {
    ...
    delayedCallRef.current = gsap.delayedCall(animationStepDuration, () => {
      ...
      // DIUBAH: Sembunyikan konten pertama saat konten kedua aktif, dan sebaliknya
      if (firstRef.current) {
        firstRef.current.style.display = activate ? 'none' : 'block';
      }
  ...
  return (
    ...
    >
      ...
      {/* DIUBAH: Tambahkan firstRef ke sini */}
      <div 
        ref={firstRef} 
